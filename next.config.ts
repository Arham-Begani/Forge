...
const securityHeaders = [
    ...
    },
    {
        ...
        value: [
            ...
            "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://generativelanguage.googleapis.com https://api.razorpay.com https://instruments-analytics.razorpay.io https://checkout.razorpay.com",
