...
Runs Research + Branding + Landing Page + Feasibility together as a coordinated Agent Team. Marketing is explicitly excluded — it always runs as its own separate module. The Architect Agent (claude-opus-4-6) orchestrates four specialist agents in parallel using Agent Teams.
...
**Agent:** Genesis Engine (claude-sonnet-4-6 + web_search)
...
**Agent:** Identity Architect (claude-sonnet-4-6)
...
**Agent:** Content Factory (claude-sonnet-4-6)
...
**Agent:** Production Pipeline (claude-sonnet-4-6)
...
**Agent:** Deep Validation (claude-sonnet-4-6 + extended thinking)
